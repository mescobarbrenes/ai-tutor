...
Conducted with Computer Science students who had experience in both traditional and online formats, allowing us to delve into personal difficulties and preferences.

#### **Focus Group**
Included students and a teaching assistant (TA) to understand group dynamics and shared experiences in learning and study habits.

#### **Public Records Analysis**
Scrutinized discussions from online student forums such as Reddit to capture broader perspectives on productivity, time management, and learning struggles.
...
### **Methods**
We developed a series of prototypes:
...
A big concern that was brought up in feedback we received in the formative phase was how our insights were broad in supporting students and we needed to narrow down how AI will be used, as there were many directions that we could take with this project. With this feedback in mind, we brainstormed a plethora of ideas for how each feature could be implemented, helping us identify which features and challenges should be prioritized. We created lo-fi sketches (which can be found in the appendix) for the following features: 
